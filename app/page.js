      ...
      <Head>
       ...
       <main className="  bg-white px-10 md:px-20 lg:px40 dark:bg-slate-700" >
        <section className=" min-h-screen"> 
          ...
          <div className=" text-5xl flex justify-center py-3 text-emerald-500"> 
        ...
        <section>
          ...
          <div className=" lg:flex gap-10" > 
            <div className=" text-center shadow-lg p-10 rounded-xl my-10 dark:bg-slate-800"  >
              ...
              <p className="py-1 text-gray-700 dark:text-gray-400">Express/MongoDB</p>
        ...
        <section>
          <div>
            ...
            <p className=" text-md py-2 leading-8 text-gray-700 dark:text-black" >Completed <span className=" text-teal-600 " >General Assemblys</span> software engineering bootcamp where I recieved extensive training in Full-Stack development with a certificate for my accomplishments.  I also recieved extensive Front-end industry training from my time at <span className=" text-teal-600" >Brainnest Consulting</span> and recieved a certifcate of my accomplishments upon my departure from them.</p>
            <p className=" text-md py-2 leading-8 text-center text-gray-700 dark:text-black" >Check out some of my projects below</p>
          </div>
